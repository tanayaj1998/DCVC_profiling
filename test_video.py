...
def main():
    ...
    #     args.i_frame_model_path = './checkpoints/acmmm2022_image_psnr.pth.tar'
    #     args.model_path ='./checkpoints/acmmm2022_video_psnr.pth.tar'
    #     args.test_config ='./dataset_config_example.json'
    #     args.w = 1
    #     args.write_stream =0 
    #     args.output_path ="output.json"
    #     args.force_intra_period =32 
    #     args.force_frame_num= 1
